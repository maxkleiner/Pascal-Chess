...
///adapit for mX4/mX5 by max also a frm template
...
procedure TChessForm1.FormCreate(Sender: TObject);
begin
 Randomize;
 maxform1.Memo2.lines.add('mX5 Chessboard Start : ' +datetimetostr(now));
end;
...
begin
  close;
  Chessbrd1.Destroy;
  showmessage('mX5 debug out - chess5 form, thread & engine destroyed');
end;
