//--------------------------------------------------------------------------
// ChessBoard Component for Delphi2-5-Delphi 12.1
// Version 3.03 - Feb 5, 2000  - 2025
...
//
// Contains graphics from Andrew Gate  adapt for mX5 by max
//--------------------------------------------------------------------------
...
procedure Register;
begin
  RegisterComponents('Chess5', [TChessBrd]);
end;
...
begin
    ...
    MoveList[_CurrentMove,1-Integer(_whiteToMove)].position:={ansistrings.}StrPas2(@_position[1]);
    ...
    MoveList[_CurrentMove,1-Integer(_whiteToMove)].position:=StrPas2(@_position[1]);
    MoveList[_CurrentMove,1-Integer(_whiteToMove)].Castling:=_castlingallowed;
    MoveList[_CurrentMove,1-Integer(_whiteToMove)].enPassant:=_EnPassant;
    LastMove:=_CurrentMove;
    LastTurn:=_whiteToMove;
